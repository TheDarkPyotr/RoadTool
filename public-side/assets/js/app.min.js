...
$(document).ready(function() {
            ...
            return "ontouchstart" in document ? this : (e = e.add(this.parent()), this.each(function() {
                function i(t) {
                    o.clearTimeout(a), o.clearTimeout(s), s = o.setTimeout(function() {
                        e.find(":focus").blur(), d.instantlyCloseOthers === !0 && e.removeClass("open"), o.clearTimeout(s), r.attr("aria-expanded", "true"), l.addClass("open"), r.trigger(u)
                    }, d.hoverDelay)
                }
                var a, s, r = t(this),
                    l = r.parent(),
    ...
    function(t) {
        ...
        function e(t, o) {
            var n;
            return n = t.hasClass("checkbox-inline") || t.hasClass("radio-inline") ? t : t.closest(".checkbox").length ? t.closest(".checkbox") : t.closest(".radio"), n.toggleClass("disabled", o)
        }
        ...
        t.expr[":"].notmdproc = function(o) {
            ...
            checkbox: function(o) {
                i(t(o ? o : this.options.checkboxElements).filter(":notmdproc").data("mdproc", !0).after("<span class='checkbox-material'><span class='check'></span></span>"))
            },
            togglebutton: function(o) {
                i(t(o ? o : this.options.togglebuttonElements).filter(":notmdproc").data("mdproc", !0).after("<span class='toggle'></span>"))
            },
            radio: function(o) {
                i(t(o ? o : this.options.radioElements).filter(":notmdproc").data("mdproc", !0).after("<span class='circle'></span><span class='check'></span>"))
            },
            input: function(o) {
            ...
            attachInputEventHandlers: function() {
                ...
                t(document).on("keydown paste", ".form-control", function(n) {
                    ...
                    t.each(this.files, function(t, o) {
                        e += o.name + ", "
                    }), e = e.substring(0, e.length - 2), e ? n.removeClass("is-empty") : n.addClass("is-empty"), n.find("input.form-control[readonly]").val(e)
                })
            },
            ripples: function(o) {
    ...
    function(t, o, n, e) {
        ...
        i.prototype.init = function() {
            ...
            var n = t.offset();
            return s.isTouch() ? (o = o.originalEvent, 1 === o.touches.length && o.touches[0].pageX - n.left) : o.pageX - n.left
        }, i.prototype.getRelY = function(t, o) {
            var n = t.offset();
            return s.isTouch() ? (o = o.originalEvent, 1 === o.touches.length && o.touches[0].pageY - n.top) : o.pageY - n.top
            ...
            var t = n.body || n.documentElement,
                o = t.style;
            return void 0 !== o.transition || void 0 !== o.WebkitTransition || void 0 !== o.MozTransition || void 0 !== o.MsTransition || void 0 !== o.OTransition
