...
?>	
	 ...
	 <?php } else { ?>
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Impostazioni Generali  <small> Super root (<?php echo $user->row['rank']; ?>)</small></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
				  ...
				  <div class="panel panel-danger">
						...
						<div class="panel-footer">
                            <a href="./all" type="button" class="btn btn-danger btn-circle"><i class="fa fa-eye"></i>
