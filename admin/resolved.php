                ...
                <div class="panel-body">
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        while($data = mysql_fetch_assoc($typed)){
                            ...
                            $report = mysql_query("SELECT * FROM city_report WHERE report_type = ".$data['type_id']." AND status = 'RISOLTA'");
        ...
        <div class="col-lg-6">
            ...
            if(isset($_POST['edit'])){
                ...
                if($report_status == 3 && $report_answer == '' || $report_status == 4 && $report_answer == '')
                    ...
                    $sql1 = mysql_query("SELECT * FROM city_report WHERE id = ".$idr." AND status = 'RISOLTA'") or die();
            ...
            $sql = mysql_query("SELECT * FROM city_report WHERE id = ".$idr." AND status = 'RISOLTA'") or die();
            $sql1 = mysql_query("SELECT * FROM city_report WHERE id = ".$idr." AND status = 'RISOLTA'") or die();
            $inside = mysql_fetch_assoc($sql1);
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="ReportStatus">
                                    ...
                                    <?php if($row['status'] == 'RISOLTA') { ?> <option value="2" selected>Approvata</option> <?php } else { ?><option value="2">Approvata</option><?php } ?>
